...
import com.panfilov.unityscript.psi.UnityScriptTypes;
...
public class UnityScriptSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(UnityScriptTypes.SEPARATOR)) {
            return SEPARATOR_KEYS;
        } else if (tokenType.equals(UnityScriptTypes.KEY)) {
            return KEY_KEYS;
        } else if (tokenType.equals(UnityScriptTypes.VALUE)) {
            return VALUE_KEYS;
        } else if (tokenType.equals(UnityScriptTypes.COMMENT)) {
            return COMMENT_KEYS;
